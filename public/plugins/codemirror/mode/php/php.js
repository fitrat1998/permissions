...
(function(mod) {
  ...
  CodeMirror.defineMIME("application/x-httpd-app.blade.php", "php");
  CodeMirror.defineMIME("application/x-httpd-app.blade.php-open", {name: "php", startOpen: true});
  CodeMirror.defineMIME("text/x-app.blade.php", phpConfig);
});
